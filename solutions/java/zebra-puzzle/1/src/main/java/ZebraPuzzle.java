class ZebraPuzzle {
    ...
    String getWaterDrinker() {
        // assignHouses(0);
        for (int i = 0; i < 5; i++) {
            System.out.println(houseColors[i] + " " + houseNationalities[i] + " " + housePets[i] + " " + houseDrinks[i] + " " + houseHobbies[i]);
        }
        for (int i = 0; i < 5; i++) {
    ...
    boolean satisifiesConstraints() {
        for (int i = 0; i < 5; i++) {
            // // Constraint 2
            // if (houseNationalities[i].equals("Englishman") && !houseColors[i].equals("red")) {
            //     return false;
            // }
            // // Constraint 3
            // if (houseNationalities[i].equals("Spaniard") && !housePets[i].equals("dog")) {
            //     return false;
            // }
            // // Constraint 4
            // if (houseColors[i].equals("green") && !houseDrinks[i].equals("coffee")) {
            //     return false;
            // }
            // // Constraint 5
            // if (houseNationalities[i].equals("Ukrainian") && !houseDrinks[i].equals("tea")) {
            //     return false;
            // }
            // Constraint 6
            ...
            // // Constraint 7
            // if (housePets[i].equals("snail") && ! houseHobbies[i].equals("dancing")) {
            //     return false;
            // }
            // // Constraint 8
            // if (houseColors[i].equals("yellow") && !houseHobbies[i].equals("painter")) {
            //     return false;
            // }
            // Constraint 11
            ...
            // // Constraint 13
            // if (houseHobbies[i].equals("football") && !houseDrinks[i].equals("orange juice")) {
            //     return false;
            // }
            // // Constraint 14
            // if (houseNationalities[i].equals("Japanese") && !houseHobbies[i].equals("chess")) {
            //     return false;
            // }
        }
        return true;
    ...
    // boolean contains(String [] toCheck, String checker) {
    //     for (String i: toCheck) {
    //         if (i != null && i.equals(checker)) {
    //             return true;
    //         }
    //     }
    //     return false;
