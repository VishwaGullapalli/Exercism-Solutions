class ZebraPuzzle {
    ...
    // Run to get all the houses assigned (value bool notused anywhere)
    ...
    // Assign houses by checking constraints
    ...
    // Constraints which need neighbours checks
    ...
    // Constraints which have fixed conditions
    ...
    // Constraints which can diretly be assigned (known w.r.t house number as already true)
